...
~\cite{olap2dc-paper}. The OLAP2DataCube tool is in fact a plugin for a well--known 
...
\section{Tabels}
\label{rw:tabels}
Tabels~\cite{tabels-web} is quite an interesting tool, which enables the user to 
