...
so--called prefixes and namespaces. Let’s look at the example:
...
that are repeated in each of them. E.g. the scheme --- http. Although that’s a rather technical
...
e.g. “populationTotal”, it would be great if they had no need to look up the full
...
\url{http://dbpedia.org/ontology/} was assigned the prefix \verb dbpedia-owl. Since the scheme
is then \verb prefix:localname, one could write:
...
It is needed to specify a URI describing the type “country”, for instance
...
Let’s get back to the demography example. We will continue with the prepared RDF
